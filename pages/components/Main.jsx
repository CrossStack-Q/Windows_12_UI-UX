  ...
  return (
    <div className="bg-[url(../public/backo.jpg)] w-screen h-screen bg-cover flex min-h-screen flex-col items-center justify-center">
      ...
      <main className="flex-1 w-full flex justify-center flex-col items-center">
        <div className="search bg-black bg-opacity-40 rounded-md">
            ...
            <Combobox value={selected} onChange={setSelected}>
              <div className="relative mt-1">
                ...
                <Transition
                  ...
                  afterLeave={() => setQuery("")}
                >
                  <Combobox.Options className="absolute -ml-4 mt-4 max-h-60 w-[30vw] overflow-auto rounded-md px-6 pb-4 bg-black bg-opacity-40 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
          ...
          <div>
            <div class="hs-tooltip inline-block [--trigger:click]">
              ...
              >
                ...
                <div
                  class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity inline-block absolute invisible z-10 max-w-xs bg-white border border-gray-100 text-left rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700"
                  role="tooltip"
                >
